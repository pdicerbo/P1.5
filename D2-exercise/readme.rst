...
4. (Optional) By overloading the () operator, provide safe access (i.e. bound check) to the matrix elements. (prototype    matrix matrix::operator()(const int i, const int j) )
